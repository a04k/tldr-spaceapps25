...
export default function Widget({ widgetData }: WidgetProps) {
  ...
  return (
    <Card className="w-full h-48 relative overflow-hidden">
      ...
      <CardContent className="bg-accent/30 h-full flex flex-col justify-between text-sm font-medium uppercase relative z-20 p-6">
        ...
        <div className="flex justify-between items-center">
          <span className="opacity-50">25°C</span>
        ...
        {/* Single blue gif centered */}
        <div className="absolute inset-0 -z-[1] flex items-center justify-center">
          <Image
            src="/assets/pc_blueprint.gif"
            alt="blueprint animation"
            width={200}
            height={200}
